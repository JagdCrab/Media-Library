    ...
    class VideoAccesser
    {
        ...
        public static VideoTagCollection GetVideoTags(VideoRecord _record)
        {
            ...
            using (var command = new SQLiteCommand())
            {
                ...
                command.Parameters.Add(new SQLiteParameter("@vid") { DbType = DbType.String, Value = _record.Vid });
        ...
        public static bool CheckIfInPlaylist(VideoRecord _videoRecord)
        {
            using (var command = new SQLiteCommand())
            {
                ...
                command.Parameters.Add(new SQLiteParameter("@vid") { DbType = DbType.String, Value = _videoRecord.Vid });
        ...
        #region Setters
        public static void CreateNewRecord(string _vid)
        {
            using (var command = new SQLiteCommand())
            {
                command.CommandText = @"Insert into [VideoRecords] ([Vid],[Inserted],[Deleted]) Values (@vid, @inserted, @deleted);";
                command.Parameters.Add(new SQLiteParameter("@vid") { DbType = DbType.String, Value = _vid });
        ...
        public static void UpdateFilePath(string _vid, string _path)
        {
            using (var command = new SQLiteCommand())
            {
        ...
        public static void UpdateFileName(string _vid, string _name)
        {
            using (var command = new SQLiteCommand())
            {
        ...
        public static void UpdateFileExtention(string _vid, string _extention)
        {
            using (var command = new SQLiteCommand())
            {
        ...
        public static void UpdateFileSize(string _vid, long _size)
        {
            using (var command = new SQLiteCommand())
            {
        ...
        public static void UpdateAlias(string _vid, string _alias)
        {
            using (var command = new SQLiteCommand())
            {
        ...
        public static void UpdateAltAlias(string _vid, string _altAlias)
        {
            using (var command = new SQLiteCommand())
            {
        ...
        public static void UpdateSeries(string _vid, string _series)
        {
            using (var command = new SQLiteCommand())
            {
        ...
        public static void UpdateAltSeries(string _vid, string _altSeries)
        {
            using (var command = new SQLiteCommand())
            {
        ...
        public static void UpdateScore(string _vid, int _score)
        {
            using (var command = new SQLiteCommand())
            {
        ...
        public static void UpdateFavorite(string _vid, bool _favorite)
        {
            using (var command = new SQLiteCommand())
            {
        ...
        public static void UpdateDuration(string _vid, TimeSpan _duration)
        {
            using (var command = new SQLiteCommand())
            {
        ...
        public static void UpdateIntensity(string _vid, string _intensity)
        {
            using (var command = new SQLiteCommand())
            {
        ...
        public static void UpdateLastPlayback(string _vid, DateTime _lastPlayback)
        {
            using (var command = new SQLiteCommand())
            {
        ...
        public static void UpdateFormat(string _vid, string _format)
        {
            using (var command = new SQLiteCommand())
            {
        ...
        public static void UpdateResolution(string _vid, string _resolution)
        {
            using (var command = new SQLiteCommand())
            {
        ...
        public static void UpdateChecksum(string _vid, string _checksum)
        {
            using (var command = new SQLiteCommand())
            {
        ...
        public static void UpdateInserted(string _vid, DateTime _inserted)
        {
            using (var command = new SQLiteCommand())
            {
        ...
        public static void UpdateDeleted(string _vid, bool _deleted)
        {
            using (var command = new SQLiteCommand())
            {
        ...
        public static void UpsertTag(string _vid, string _text, Intensity _intensity, bool _deleted)
        {
            long tid = 0;
            using (var command = new SQLiteCommand())
            {
